...
#Window Creation#
title_A = "IPFinder: 0.5.3"#		<-- Title of Customization Window
...
version_title = "Version: 0.5.3"#	<-- Version Number
...
#-=-Tickboxes-=-#
	...
	ma_hostgrab_var = tk.IntVar()#	[<-- Tick box Variable creation
...
def main_menu():
	...
	#Text Boxes#
	wb_thread_count.pack()
	wb_thread_count.place(relx = 0.3, rely = 0.35, anchor = W)
